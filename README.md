...
see the file [hac-to-corrected-with-vechat-twice-ultra-long.smk](https://github.com/jelber2/hac-to-duplex/blob/main/hac-to-corrected-with-vechat-twice-ultra-long.smk) in this repo, the steps look like this:
